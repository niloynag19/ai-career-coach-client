...
import { Compass, Menu, X, User as UserIcon, LayoutDashboard, Settings, Shield, LogOut } from "lucide-react";
      ...
      className={cn(
        ...
        isScrolled
          ...
          : (pathname.startsWith("/services/") && pathname !== "/services") || (pathname.startsWith("/blog/") && pathname !== "/blog")
            ? "bg-background/80 backdrop-blur-md border-border shadow-sm py-5"
